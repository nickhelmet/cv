...
const CV = {
  ...
  skills: {
    es: [
      ...
      { group: "Observabilidad", items: ["Grafana", "Prometheus", "Alertmanager", "Thanos", "InfluxDB", "Tempo", "Loki", "Pyroscope", "LibreNMS"] },
    ...
    en: [
      ...
      { group: "Observability", items: ["Grafana", "Prometheus", "Alertmanager", "Thanos", "InfluxDB", "Tempo", "Loki", "Pyroscope", "LibreNMS"] },
